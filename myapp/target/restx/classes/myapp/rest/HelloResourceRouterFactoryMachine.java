...
import myapp.rest.HelloResourceRouter;
...
private final Factory.Query<myapp.rest.HelloResource> resource = Factory.Query.byClass(myapp.rest.HelloResource.class).mandatory();
