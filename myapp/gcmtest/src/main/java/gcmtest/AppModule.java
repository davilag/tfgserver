...
public class AppModule {
    ...
    public SignatureKey signatureKey() {
         return new SignatureKey("5816891511216071727 gcmtest GCMTest f8dbbe24-3d11-417d-86f3-81a481247b2d".getBytes(Charsets.UTF_8));
    }
    ...
    public ConfigSupplier appConfigSupplier(ConfigLoader configLoader) {
        // Load settings.properties in gcmtest package as a set of config entries
        return configLoader.fromResource("gcmtest/settings");
    }
